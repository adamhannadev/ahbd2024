...
class FiguresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create figure" do
    assert_difference("Figure.count") do
      post figures_url, params: { figure: { dance: @figure.dance, level: @figure.level, manref: @figure.manref, name: @figure.name, style: @figure.style } }
    end
  ...
  test "should update figure" do
    patch figure_url(@figure), params: { figure: { dance: @figure.dance, level: @figure.level, manref: @figure.manref, name: @figure.name, style: @figure.style } }
