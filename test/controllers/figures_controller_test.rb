...
class FiguresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create figure" do
    assert_difference("Figure.count") do
      post figures_url, params: { figure: { figure_description: @figure.figure_description, figure_name: @figure.figure_name } }
    end
  ...
  test "should update figure" do
    patch figure_url(@figure), params: { figure: { figure_description: @figure.figure_description, figure_name: @figure.figure_name } }
